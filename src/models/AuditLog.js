...
const auditLogSchema = new mongoose.Schema({
    ...
    action: {
        ...
        enum: [
            ...
            'custom', 'email_verification_sent', 'email_verification_resent','role_management','permission_management','admin',
        ]
    },
    ...
    category: {
        ...
        enum: [
            ...
            'file_operations', 'reporting', 'configuration', 'custom','role_management','permission_management','admin'
        ],
        default: 'custom'
    },
